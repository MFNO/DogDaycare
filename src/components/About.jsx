...
export default function About() {
  ...
  return (
    <div style={{ padding: `${pad}px 16px`, maxWidth: 960, margin: '0 auto' }}>
      <Title level={screens.xs ? 3 : 2} style={{ textAlign: 'center', marginBottom: 24 }}>
        {site.sections.about}
      </Title>
      <Paragraph style={{ fontSize: screens.xs ? 15 : 16, lineHeight: 1.75, marginBottom: 32 }}>
        {site.aboutText}
      </Paragraph>
      <Row gutter={[24, 24]}>
        <Col xs={24} md={12}>
        ...
        <Col xs={24} md={12}>
          <Space direction="vertical" size="small" style={{ width: '100%' }}>
            <Text strong>
              <EnvironmentOutlined /> Location &amp; service area
            </Text>
